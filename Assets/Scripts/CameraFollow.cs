...
public class CameraFollow : MonoBehaviour
{
    ...
    //Vector3 offset;//相机初始的时候与主角之间的距离
    ...
    //void Update()
    //{
    //    Vector3 cameraPos = target.position + offset;//相机运动目标位置
    //    transform.position = Vector3.Lerp(transform.position, cameraPos, Time.deltaTime * speed); //相机运动
    //}
